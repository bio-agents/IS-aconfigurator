...
package org.isaagents.isacreatorconfigurator.ontologyconfigurationagent;
...
import org.isaagents.isacreatorconfigurator.configui.notifications.NotificationWindow;
...
public class OntologyConfigUI extends JFrame {
    ...
    public OntologyConfigUI(List<Ontology> ontologiesToBrowseOn, Map<String, RecommendedOntology> currentlySelectedOntologies) {
        ...
        ResourceInjector.get("ontologyconfigagent-package.style").inject(this);
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent mouseEvent) {
                ...
                if (removedOntologies.size() > 0) {
                    ...
                    message.append("<html>The following ontologies are not supported in ISA agents and have been removed from the recommended ontologies:<strong>");
                    int count = 0;
