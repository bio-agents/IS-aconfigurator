...
import org.isaagents.isacreator.gui.ISAcreatorTitlePanel;
...
public class ISAcreatorConfigurator extends AnimatableJFrame {
    ...
    static {
        ...
        UIManager.put("AgentTip.foreground", UIHelper.DARK_GREEN_COLOR);
        UIManager.put("AgentTip.background", UIHelper.TRANSPARENT_LIGHT_GREEN_COLOR);
        ...
        ResourceInjector.get("ontologyconfigagent-package.style").load(
                ISAcreatorConfigurator.class.getResource("/dependency-injections/ontologyconfigagent-package.properties"));
