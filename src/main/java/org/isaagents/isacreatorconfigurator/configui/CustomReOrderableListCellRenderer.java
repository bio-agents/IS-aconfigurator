...
public class CustomReOrderableListCellRenderer extends JLabel implements ListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean hasFocus) {
        ...
        if (ApplicationManager.getFileErrors().containsKey(currentMappingObject)) {
            ...
            if (indexContained || fieldContained) {
                ...
                createAgentTip(key, ApplicationManager.getFileErrors().get(currentMappingObject));
            } else {
    ...
    private void createAgentTip(String key, Map<String, Set<String>> errors) {
        ...
        setAgentTipText("<html>" + fieldErrors.toString() + "</html>");
    }
